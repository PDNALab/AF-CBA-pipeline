...
key_residues = {               #Key residues should be changed
    "I42": "CA",
    "E43": "CA",
    "I44": "CA",
}
...
for seq_num in range(1, len(total_frag)+1):  # Adjust the range as needed
    ...
    try:
        ...
        if pep_plddt>=70 and average_distance <15:
...
colors = ['#B40426' if i < 15 and j>=  70 else '#3B4CC0' for i, j in zip(distance_list,plddt_list)]
print(len(colors))
